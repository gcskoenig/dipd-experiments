"""
In this script we visualize the results of the DIP decomposition of the SAGE values on the wine dataset.
Assumes that script_sage.py was already run.
"""
...
plt.figure()
ax = forceplot(scores_plt.T, 'Wine Quality', figsize=(3.25, 1.5), ylabel='Normalized Scores',
